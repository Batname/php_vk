...
class VKLIKES {
    ...
    private $count = 19; //По сколько "репостов" и "лайков" доставать
    private $countpost;
    ...
    public function __construct($owner_id = '-20629724', $post_id = '621929') {
